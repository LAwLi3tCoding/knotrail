...
export interface SandboxOptions { workdir: string; dataDir: string; allowNetwork: boolean; lockFd: number; timeoutMs: number; protectedPaths: string[]; onFileIntent?: (intent: FileMutationIntent) => Promise<void> | void }
