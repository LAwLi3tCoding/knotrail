...
export default function App() {
  ...
  async function selectTask(id: string) {
    ...
    selectedRef.current = id; setSelected(id); setPage('task'); setPlanVersion('current'); if (narrow) setNavCollapsed(true); setSnapshot(undefined); setImpact(undefined); setPrefs(defaults()); prefsRef.current = defaults();
    try {
